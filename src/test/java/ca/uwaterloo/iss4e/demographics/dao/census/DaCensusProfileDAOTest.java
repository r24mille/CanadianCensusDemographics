...
public class DaCensusProfileDAOTest {
	...
	public void testParseDaCensusData() {
		...
		Collection<DaCensusProfile> daCensusProfiles = daCensusProfileDAO.getDaCensusProfiles(Province.PEI_PROV_ID);

		for (DaCensusProfile censusProfile : daCensusProfiles) {
			if (censusProfile.getDaId() == 11030078) {
